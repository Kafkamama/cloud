                        ...
                        <div  class="col comp-grid" >
                            <div >
                                ...
                                <div  class=" row q-col-gutter-xs justify-start q-ma-md">
                                    <div><q-btn icon="edit" :label="$t('edit')"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="positive" :title="$t('edit')"  @click="app.openPageDialog({ page:'student/edit', url: `/student/edit/${item.student_id}` , closeBtn: true })">
                                    </q-btn></div>
                                    <div><q-btn icon="delete_sweep" :label="$t('delete')"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="negative" :title="$t('delete')"  @click="deleteItem(item.student_id)">
                                    </q-btn></div>
                                </div>
                            </div>
                        </div>
