                ...
                <div class="container-fluid">
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/course/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/course"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.courselistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="course_id" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/course/view/${props.row.course_id}`">{{ props.row.course_id }}</q-btn>
                                    </q-td>
                                    <q-td  key="teacher_id" :props="props">
                                        <q-btn v-if="props.row.teacher_id" @click="app.openPageDialog({ page: 'teacher/view', url: `/teacher/view/${props.row.teacher_id}` , closeBtn: true })" padding="xs" flat color="primary" no-caps >
                                            <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  {{ $t('teacher') }}
                                        </q-btn>
                                    </q-td>
                                    ...
                                    <q-td  key="learning_objectives" :props="props">
                                        {{ props.row.learning_objectives }}
                                    </q-td>
                                    <q-td  key="target_audience" :props="props">
                                        {{ props.row.target_audience }}
                                    </q-td>
                                    <q-td  key="estimated_duration" :props="props">
                                        {{ props.row.estimated_duration }}
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        <q-item link clickable v-ripple :to="`/course/view/${props.row.course_id}`">
                                                            <q-item-section>
                                                                <q-icon color="primary" size="sm" name="visibility"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>{{ $t('view') }}</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple :to="`/course/edit/${props.row.course_id}`">
                                                            <q-item-section>
                                                                <q-icon color="positive" size="sm" name="edit"></q-icon>
                                                            </q-item-section>
                                                            <q-item-section>{{ $t('edit') }}</q-item-section>
                                                        </q-item>
                                                        <q-item link clickable v-ripple @click="deleteItem(props.row.course_id)">
                                                            <q-item-section>
