<template>
    <div id="master-detailpage">
        <q-tabs  inline-label v-model="selectedTab" active-color="primary" indicator-color="primary" align="left">
            <q-tab no-caps name="certificate" icon="extension" :label="$t('studentCertificate')" />
        </q-tabs>
        <q-separator></q-separator>
        <q-tab-panels keep-alive v-model="selectedTab" animated>
            <q-tab-panel class="q-pa-none" name="certificate">
                <div class="reset-grid">
                    <list-certificate-page ref="certificateListPage"  field-name="certificate.student_id" :field-value="masterRecord.student_id" :show-header="false" :show-breadcrumbs="false" isSubPage>
...
const app = useApp();
const store = usePageStore('STUDENT');
...
function setDetailPageFormData(){
	...
	certificateStore.setFormData({ student_id:record?.student_id });
}
