...
async function exportListPage(records, req, res) {
		try{
			...
			let columns =  [
				...
				{ header: "Resource Url", key: "resource_url" }
		]
		let filename = "courseresourcelist-report";

		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Course Resource");
			...
			let page = "courseresourcelist.ejs";
