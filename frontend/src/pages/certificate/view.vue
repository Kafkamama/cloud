                        ...
                        <div  class="col comp-grid" >
                            <div >
                                <div class="q-mb-3 row justify-start q-col-gutter-sm">
                                    <div class="col-12">
                                        <q-card  class="q-pa-md nice-shadow-6">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">{{ $t('certificateId') }}</div>
                                                    <div class="text-bold">{{ item.certificate_id }}</div>
                                                </div>
                                            </div>
                                        </q-card>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <q-card  class="q-pa-md nice-shadow-6">
                                            <div class="row q-col-gutter-x-md items-center">
                                                <div class="col">
                                                    <div class="text-grey text-weight-medium mb-1">{{ $t('issueDate') }}</div>
                                ...
                                <div  class=" row q-col-gutter-xs justify-start q-ma-md">
                                    <div><q-btn icon="edit" :label="$t('edit')"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="positive" :title="$t('edit')"  @click="app.openPageDialog({ page:'certificate/edit', url: `/certificate/edit/${item.certificate_id}` , closeBtn: true })">
                                    </q-btn></div>
                                    <div><q-btn icon="delete_sweep" :label="$t('delete')"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="negative" :title="$t('delete')"  @click="deleteItem(item.certificate_id)">
                                    </q-btn></div>
                                </div>
                            </div>
                        </div>
