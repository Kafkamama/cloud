                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-input  ref="ctrlpurchase_date" v-model="formData.purchase_date" :label="$t('purchaseDate')"    :error="isFieldValid('purchase_date')" :error-message="getFieldError('purchase_date')">
                                                    <template v-slot:append>
                                                        <q-icon name="date_range" class="cursor-pointer">
                                                        <q-popup-proxy ref="ctrlpurchase_date" transition-show="scale" transition-hide="scale">
                                                        <q-date    mask="YYYY-MM-DD" v-model="formData.purchase_date" @input="$refs.ctrlpurchase_date.hide()" />
                                                        </q-popup-proxy>
                                                        </q-icon>
                                                    </template>
                                                    </q-input>      
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'purchaserecordadd',
		},
		apiPath : {
			type : String,
			default : 'purchaserecord/add',
		},
		submitButtonLabel: {
			type: String,
			default: () => $t('submit'),
